...
/* __dirname gives the directory of the place where our project is available. Whilst in localhost it is the folder where it is stored but when it si uploaded to render, it will be different */
